...
CodeSphere uses a custom OT implementation on both the client and server to keep all participants’ views of a document consistent.
...
Run CodeSphere locally using Docker:
